...
<html>
   <head>
      <title>flake8 violations: .venv/lib/python3.10/site-packages/setuptools/logging.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.lib.python3.10.site-packages.setuptools.logging.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.lib.python3.10.site-packages.setuptools.logging.source.html#l29">
                  <tt><i>29</i>         <span class="c1"># For some reason `distutils.log` module is getting cached in `distutils.dist`</span></tt>
               </a>
            </li>
            </ul>
         </li>
