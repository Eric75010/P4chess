...
<html>
   <head>
      <title>flake8 violations: .venv/lib/python3.10/site-packages/setuptools/_importlib.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.lib.python3.10.site-packages.setuptools._importlib.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.lib.python3.10.site-packages.setuptools._importlib.source.html#l22">
                  <tt><i>22</i> <span class="sd">            This problem is likely to be solved by installing an updated version of</span></tt>
               </a>
            </li>
            </ul>
         </li>
